...
for two completely different categories of **merging** data objects. 
...
Often this takes the form of a table-join, where non-matching keys are omitted in the result.
In this case, keys are Sample IDs or Taxa IDs, respectively.
