---
title: "Functions for Accessing and (Pre)Processing Data"
date: "`r date()`"
output: 
  html_document: 
    toc: yes
...
This results in a highly-subsetted object, `GPfr`, containing just `r ntaxa(GPfr)` of the original ~`r ntaxa(GlobalPatterns)` OTUs. Note that in both lines we have provided a custom function for transformation and filtering, respectively.
...
```{r transform-counts-ex, eval=FALSE}
