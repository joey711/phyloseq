...
This page demos already-constructed examples of phylogenetic trees 
created via the `plot_tree` function in 
[the phyloseq package](http://joey711.github.com/phyloseq/), 
which in-turn uses the powerful graphics package called 
