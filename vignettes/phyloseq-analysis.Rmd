...
pdpcoa <- plot_ordination(GP, GP.dpcoa, type="biplot", color="SampleType", shape="Phylum")
...
# Split
plot_ordination(GP, GP.dpcoa, type="split", color="SampleType", shape="Phylum")
```
...
ent.p.table <- mt(x, "Enterotype", test="f", B=1000)
