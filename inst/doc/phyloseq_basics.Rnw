...
\begin{figure}
\begin{center}
\includegraphics[width=0.55\textwidth]{basics/import_qiime_directory_structure.pdf}
...
\begin{figure}
\begin{center}
\includegraphics[width=0.7\textwidth]{basics/phyloseq_classes_3_clipped.pdf}
