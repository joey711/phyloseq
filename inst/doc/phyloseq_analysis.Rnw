...
\begin{figure}[htbp]
\centering
\subfloat[Axes 1, 2]{\label{fig:sub:GPCA12}\includegraphics[width=0.47\textwidth]{phyloseq_analysis-GPfig5ax12}}
\subfloat[Axes 1, 3]{\label{fig:sub:GPCA34}\includegraphics[width=0.53\textwidth]{phyloseq_analysis-GPfig5ax13}}
...
\code{DPCoA()}~\cite{Pavoine2004523}.
