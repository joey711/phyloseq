...
@
<<echo=FALSE>>=
ggsave("phyloseq_analysis-plot_tree_example.pdf", p, width=15, height=7)
@

\begin{figure}[htbp]
\centering
\includegraphics[width=0.99\textwidth]{phyloseq_analysis-plot_tree_example.pdf}
...
@
<<echo=FALSE>>=
ggsave("phyloseq_analysis-plot_sample_network.pdf", p, width=11, height=7)
@
...
\begin{figure}[htbp]
\centering
\subfloat[UniFrac / UPGMA]{\label{fig:sub:GPfig4}
...
@
%\includegraphics[width=0.5\textwidth]{phyloseq_analysis-GPfig4}}
\subfloat[Jaccard / CLC]{\label{fig:sub:GPjaccCLC}
\setkeys{Gin}{width=0.45\textwidth}
...
tiplabels(GP.tip.labels, col=cols, frame="none", adj=-0.05, cex=0.7)
@
%\includegraphics[width=0.5\textwidth]{phyloseq_analysis-GPfig4jaccCLC}}
\captionsetup{width=1.0\textwidth}
