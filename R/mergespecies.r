...
#'
#' @import ape phylobase
#' @export
#' @keywords merge species
...
# The method name otuTree4 is a placeholder while migrate "phylo"
# slot to "phylo4" slot of phylobase package. Lots more potential
