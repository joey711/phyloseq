...
#' }
#'
deprecated_phyloseq_function <- function(x, value, ...) {
  return(NULL)
}
plot_taxa_bar <- function(...) {
  .Deprecated("plot_bar", package = "phyloseq")
  return(plot_bar(...))
}
taxaplot <- function(...) {
  .Deprecated("plot_bar", package = "phyloseq")
...
speciesSums <- function(...) {
  .Deprecated("taxa_sums", package = "phyloseq")
  return(taxa_sums(...))
}
sampleSums <- function(...) {
  .Deprecated("sample_sums", package = "phyloseq")
  return(sample_sums(...))
}
nspecies <- function(...) {
  .Deprecated("ntaxa", package = "phyloseq")
  return(ntaxa(...))
}
species.names <- function(...) {
  .Deprecated("taxa_names", package = "phyloseq")
  return(taxa_names(...))
}
sampleNames <- function(...) {
  .Deprecated("sample_names", package = "phyloseq")
  return(sample_names(...))
}
...
getSamples <- function(...) {
  .Deprecated("get_sample", package = "phyloseq")
  return(get_sample(...))
}
getSpecies <- function(...) {
  .Deprecated("get_taxa", package = "phyloseq")
  return(get_taxa(...))
}
rank.names <- function(...) {
  .Deprecated("rank_names", package = "phyloseq")
  return(rank_names(...))
}
getTaxa <- function(...) {
  .Deprecated("get_taxa_unique", package = "phyloseq")
  return(get_taxa_unique(...))
}
sample.variables <- function(...) {
  .Deprecated("sample_variables", package = "phyloseq")
  return(sample_variables(...))
}
getVariable <- function(...) {
  .Deprecated("get_variable", package = "phyloseq")
  return(get_variable(...))
}
merge_species <- function(...) {
  .Deprecated("merge_taxa", package = "phyloseq")
  return(merge_taxa(...))
}
otuTable <- function(...) {
...
speciesarerows <- function(...) {
  .Deprecated("taxa_are_rows", package = "phyloseq")
  return(taxa_are_rows(...))
}
speciesAreRows <- function(...) {
  .Deprecated("taxa_are_rows", package = "phyloseq")
  return(taxa_are_rows(...))
...
plot_richness_estimates <- function(...) {
  .Deprecated("plot_richness", package = "phyloseq")
  return(plot_richness(...))
}
import_qiime_sampleData <- function(...) {
  .Deprecated("import_qiime_sample_data", package = "phyloseq")
  return(import_qiime_sample_data(...))
}
filterfunSample <- function(...) {
  .Deprecated("filterfun_sample", package = "phyloseq")
  return(filterfun_sample(...))
}
genefilterSample <- function(...) {
  .Deprecated("genefilter_sample", package = "phyloseq")
  return(genefilter_sample(...))
}
prune_species <- function(...) {
  .Deprecated("prune_taxa", package = "phyloseq")
  return(prune_taxa(...))
}
subset_species <- function(...) {
  .Deprecated("subset_taxa", package = "phyloseq")
  return(subset_taxa(...))
}
tipglom <- function(...) {
  .Deprecated("tip_glom", package = "phyloseq")
  return(tip_glom(...))
}
taxglom <- function(...) {
  .Deprecated("tax_glom", package = "phyloseq")
  return(tax_glom(...))
}
tre <- function(...) {
...
show_mothur_list_cutoffs <- function(...) {
  .Deprecated("show_mothur_cutoffs", package = "phyloseq")
  return(show_mothur_cutoffs(...))
}
originalUniFrac <- function(...) {
  .Deprecated("fastUniFrac", package = "phyloseq")
  return(fastUniFrac(...))
}
